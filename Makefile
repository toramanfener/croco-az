...
migrate-up:
	migrate -source file://migrations \
		-database 'postgres://postgres:sukaPizdecSlozhniyParol228@localhost:5432/postgres?sslmode=disable' up

migrate-down:
	migrate -source file://migrations -database \
		'postgres://postgres:sukaPizdecSlozhniyParol228@localhost:5432/postgres?sslmode=disable' down 1
